import random, time, pygame, sys, webbrowser
...
def main():
    global FPSCLOCK, DISPLAYSURF, BASICFONT, BIGFONT, GAMEPAD, BG
    pygame.init()
    ...
    while True:
        ...
        pygame.mixer.music.load('herostorm.mp3')
...
def showTextScreen(text):
    ...
    GAMEPAD.blit(titleSurf, titleRect)
    ...
    GAMEPAD.blit(pressKeySurf, pressKeyRect)
...
def drawBoard(board):
    ...
    pygame.draw.rect(DISPLAYSURF, Background, (XMARGIN, TOPMARGIN, BOXSIZE * BOARDWIDTH, BOXSIZE * BOARDHEIGHT))
